...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private RuntimeExceptionDao<MenuItem, Integer> menuRuntimeDao = null;
...
//	}
    ...
    /**
	 * Returns the RuntimeExceptionDao (Database Access Object) version of a Dao for our MenuItem class. It will
	 * create it or just give the cached value. RuntimeExceptionDao only through RuntimeExceptions.
     * @return menuRuntimeDao runtime DAO object for menu class
	 */
	public RuntimeExceptionDao<MenuItem, Integer> getMenuRuntimeDao() {
		if (menuRuntimeDao == null) {
			menuRuntimeDao = getRuntimeExceptionDao(MenuItem.class);
		}
